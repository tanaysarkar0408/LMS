...
const AddCouse = () => {
  ...
  const handleSubmit = async (e) =>{
    try {
      ...
      formmData.append('courseData', JSON.stringify(courseData))
      formmData.append('image', image)

      const token = await getToken()
      const {data} = await axios.post(backendUrl + '/api/educator/add-course', formmData, {
        headers : {
    ...
    justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0' >
      ...
      className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        <div className='flex flex-col gap-1'>
          <p>Course Title</p>
          <input onChange={e=> setCourseTitle(e.target.value)} type="text" value={courseTitle}
                ...
                <div className='p-4'>
                  {chapter.chapterContent.map((lecture, lectureIndex)=> (
                    <div key={lectureIndex} className='flex justify-between items-center mb-2'>
                      <span>
                        {lectureIndex+1} {lecture.lectureDetails} - {lecture.lectureDuration} mins - <a href={lecture.lectureUrl} 
                ...
                <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-80'>
                  ...
                  <div className='mb-2'>
                    ...
                    />
                      ...
                      <img src={assets.cross_icon} onClick={() => setShowPopup(false)} className='absolute top-4 
